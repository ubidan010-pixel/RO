                    ...
                    case NetworkClientBase.ClientEventTypeEnum.RawDataRecieved:
                        {
                            ...
                            byte[] DataToSend = (byte[])incommingEvent.EventData;
                            System.Text.ASCIIEncoding enc = new System.Text.ASCIIEncoding();
                            string msg = enc.GetString(DataToSend);
                            //Disconnection could be also sent by a string
                            string k = worker.GetType().Name;
                            if (msg.Contains(BasicNetCmd.NetDisconnectionCmd))
                            {
                                switch (worker.GetType().Name)
                                {
                                    ...
                                    case "NetworkServerClientAccepter": //This class add it so it should remove it.
                                        ...
                                        incommingEvent.EventType = NetworkClientBase.ClientEventTypeEnum.Disconnected;

...
#define _ITF_COLORCOMPUTER_PLUGIN_H_
...
namespace ITF
{
    class colorComputer_Plugin : public Interface_ActorEditorListener
    {
    public:
        ...
        virtual                                 ~colorComputer_Plugin(){};

    private:
        static colorComputer_Plugin*                   m_instance;
    };

#ifndef ITF_CORE_MEMMNG_PRIVATE_H_
#define ITF_CORE_MEMMNG_PRIVATE_H_

#pragma once

#include "Core/system/Synchronize.h"
#include "MemMngConfig.h"
...
#if defined(ITF_PS5)
#include "MemMngPrivatePlatform_PS5.h"
#elif defined(ITF_NINTENDO)
#include "MemMngPrivatePlatform_Nintendo.h"
#else
...
namespace MemMngDebug
{
    ...
    //////////////////////////////////////////////////////////////////////////
    uPtr GetCurrentPhysicalMemoryUsed(); // get the currently physical memory. Can take several seconds in extreme cases.
    uPtr GetTotalPhysicalMemory(); // get the total physical memory. Static value.
    ...
    #else
        #define	MEMMNG_ASSERT(expr) do { (void)sizeof(expr); } while(0)
    #endif
...
namespace MemMngTools
{
    ...
    inline unsigned int GetAlignFromAdrs(void *pAdrs, unsigned int uAlign)
    {
        ...
        unsigned long v = (unsigned long)pAdrs;
...
#endif // ITF_CORE_MEMMNG_PRIVATE_H_

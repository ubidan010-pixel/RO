...
namespace ITF
{
    ...
    class Ray_GameScreen_LevelStats : public GameScreenBase, public Ray_Pause_MenuItemActionListener
    {
        DECLARE_OBJECT_CHILD_RTTI(Ray_GameScreen_LevelStats,GameScreenBase,2786744658)

    public:

        //Implementation of base class members

        Ray_GameScreen_LevelStats();
        ~Ray_GameScreen_LevelStats();

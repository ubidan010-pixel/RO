...
#define _ITF_PLATFORMTREE_PLUGIN_H_
...
namespace ITF
{
    class PlatformTree_Plugin : public Interface_ActorEditorListener
    {
        static PlatformTree_Plugin* s_instance;

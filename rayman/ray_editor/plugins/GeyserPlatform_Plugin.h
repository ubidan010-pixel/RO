...
#define _ITF_GEYSERPLATFORM_PLUGIN_H_
...
namespace ITF
{
    ...
    class GeyserPlatform_Plugin : public Interface_ActorEditorListener
    {
        static GeyserPlatform_Plugin* s_instance;
    ...
    public:
        ...
        GeyserPlatform_Plugin();
        virtual ~GeyserPlatform_Plugin();
    ...
    private:
        ...
        Ray_GeyserPlatformAIComponent* getComponent( PickingShape* _shape );

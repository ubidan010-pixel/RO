...
#define _ITF_NEEDSINITPOSPICKINGSHAPE_PLUGIN_H_
...
namespace ITF
{
    class NeedsInitPosPickingShape_Plugin : public Interface_ActorEditorListener
    {
        static NeedsInitPosPickingShape_Plugin* s_instance;
    ...
    public:
        ...
        NeedsInitPosPickingShape_Plugin();
        virtual ~NeedsInitPosPickingShape_Plugin();
        ...
        virtual bbool   needsInitPosPickingShape( Actor* _actor, ActorComponent* _component );

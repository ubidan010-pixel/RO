    ...
    namespace NVN
    {
        ...
        namespace VRAMAllocator
        {
            ...
            public:
                ...
                PoolContainer(nvn::Device & _device, bbool _autoAllocPool = btrue, bbool _forceOOM = bfalse);
                PoolContainer(const PoolContainer&) = delete;
                ~PoolContainer();

                PoolContainer & operator = (const PoolContainer&) = delete;

                nvn::Device& getDevice() const { return *m_device; }

                // create a pool in a pre allocated area
                class ChunkContainer * createPool(VRAMAddress _startOfBlock, ChunkSize _blockSize, VRAMResourceType _resType);
            ...
            private:
                friend class ::ITF::NVN::VRAMRelocHandle;
                //////////////////////////////////////////////////////////////////////////
                // RelocHdl access
                //////////////////////////////////////////////////////////////////////////
                ...
                // nvn utils
                static nvn::MemoryPoolFlags toPoolFlag(VRAMResourceType _resType);
                nvn::MemoryPoolBuilder createMemPoolBuilder(VRAMAddress _startOfBlock, ChunkSize _blockSize, VRAMResourceType _resType);
                ...
                nvn::Device* m_device = nullptr; // NVN device, needed to create memory pools

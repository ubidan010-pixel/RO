...
namespace ITF::NVN
{
    ...
    enum class VRAMResourceType : ux
    {
        RENDER_TARGET = 0,
        RESOURCE,
        TEXTURE, // simply sampled textures (not render targets)
        SHADER,
        Count,
    };
    ...
    namespace VRAMAllocator
    {
        ...
        // This is what is usually required for storage methods of nvn builders.
        struct GPUStorage
        {
            nvn::MemoryPool* memoryPool = nullptr;
            VRAMOffset offset = 0;
            ChunkSize size = 0;
        };
    }

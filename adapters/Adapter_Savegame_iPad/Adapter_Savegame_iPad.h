...
#define _ITF_ADAPTER_SAVEGAME_IPAD_H__
...
namespace ITF
{
    ...
    class Adapter_Savegame_iPad : public Adapter_Savegame
    {
    public:
        Adapter_Savegame_iPad();
        virtual ~Adapter_Savegame_iPad() {}
...
#endif // _ITF_ADAPTER_SAVEGAME_IPAD_H__

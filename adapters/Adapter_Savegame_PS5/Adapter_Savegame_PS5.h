#ifndef ITF_ADAPTER_SAVEGAME_PS5_H_
#define ITF_ADAPTER_SAVEGAME_PS5_H_
...
namespace ITF
{
    class Adapter_Savegame_PS5 : public Adapter_Savegame
    {
    public:

        Adapter_Savegame_PS5();
        virtual ~Adapter_Savegame_PS5();
...
#define SAVEGAME_ADAPTER_PS5 (static_cast<Adapter_Savegame_PS5*>(SAVEGAME_ADAPTER))
}

#endif // ITF_ADAPTER_SAVEGAME_PS5_H_

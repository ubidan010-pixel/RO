...
namespace Microsoft::Xbox::Wrappers::GameSave
{
    class Provider;
}
...
namespace ITF
{
    class Adapter_Savegame_XBoxSeries : public Adapter_Savegame
    {
    public:
        Adapter_Savegame_XBoxSeries();
        ~Adapter_Savegame_XBoxSeries() override;
        ...
        /// @param _baseName
        /// @param _displayName
        virtual bbool getEnumeratedContent(u32 _playerIndex, u32 _slotIndex, String8& _baseName, String& _displayName, bbool& _emptyContent) override;
    ...
    private:
        ...
        struct SaveDataEntry
        {
            ...
            void loadFromBuffer(const BlobData& _buffer);
            void saveToBuffer(BlobData& _buffer) const;
        ...
        UniquePtr<Microsoft::Xbox::Wrappers::GameSave::Provider> m_provider{};
        ...
        void processLoadOperation(SaveDataEntry& dataLoaded); // in thread
        void processSaveOperation(const SaveDataEntry& dataToSave); // in thread
    };

    #define SAVEGAME_ADAPTER_XBOXSERIES    ( static_cast<ITF::Adapter_Savegame_XBoxSeries*>(SAVEGAME_ADAPTER) )
}

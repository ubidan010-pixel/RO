...
void RewardAdapter_PS5::registerContexAndGetUnlockTrophies()
{
	...
	data->adapter = this;
	m_taskManager->pushTask(task_runRegisterAndUnlockedTrophy, task_runRegisterAndUnlockedTrophyCallback, (void*)data);
}

i32 RewardAdapter_PS5::task_runRegisterAndUnlockedTrophy(void* _param)
{
...
void RewardAdapter_PS5::task_runRegisterAndUnlockedTrophyCallback(void* _param, i32 res)
{
	RegisterTrophyData* pDatas = (RegisterTrophyData*)_param;
	if (res == SCE_OK)
	{
...
void RewardAdapter_PS5::registerUDSContext()
{
	...
	data->adapter = this;
	m_taskManager->pushTask(task_runRegisterUDSContext, task_runRegisterUDSContextCallback, (void*)data);
}

i32 RewardAdapter_PS5::task_runRegisterUDSContext(void* _param)
{
...
void RewardAdapter_PS5::task_runRegisterUDSContextCallback(void* _param, i32 res)
{
	RegisterUDSData* pDatas = (RegisterUDSData*)_param;
	if (res == SCE_OK)
	{
...
void RewardAdapter_PS5::task_unlockTrophyTaskCallback(void* _param, i32 res)
{
	UnlockTrophyData* pDatas = (UnlockTrophyData*)_param;
	if (res == SCE_OK)
	{

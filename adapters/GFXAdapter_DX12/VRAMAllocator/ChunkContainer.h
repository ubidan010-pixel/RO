...
namespace ITF::DX12::VRAMAllocator
{
    ...
    public:
        ...
        void Init(ComPtr<ID3D12Heap> _heap, bool forceOOMBreak, bool verboseOutOfMem = false, bool staticBuffer = false);
        ...
        GPUStorage GetStorage(ChunkIdx idx) const
        {
            ...
            return GPUStorage{ m_memoryHeap, offset, chunk.size}; }
        ...
        ComPtr<ID3D12Heap> getMemoryHeap() const { return m_memoryHeap; }
    ...
    private:
        ...
        ComPtr<ID3D12Heap> m_memoryHeap{};

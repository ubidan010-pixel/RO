...
namespace ITF::DX12
{
    ...
    public:
        ...
        public:
            ...
            void* getAsVoidP() const { return reinterpret_cast<void*>(iPtr(m_idx + 1)); }
        ...
        using TexSamplerHdl = Handle<Texture>;
        ...
        struct SamplerMode
        {
            GFX_TEXADRESSMODE wrapModeU = GFX_TEXADRESSMODE::GFXTADDRESS_WRAP;
            GFX_TEXADRESSMODE wrapModeV = GFX_TEXADRESSMODE::GFXTADDRESS_WRAP;
            bool linearFiltering = true;
        };

        void setTexture(TexSamplerHdl _hdl, Texture* _tex);
        void setSamplerMode(TexSamplerHdl _hdl, SamplerMode _samplerMode);
        void setSamplerMode(TexSamplerHdl _hdl, GFX_TEXADRESSMODE _wrapModeU, GFX_TEXADRESSMODE _wrapModeV, bool _linearFiltering)
        {
            setSamplerMode(_hdl, SamplerMode{ _wrapModeU, _wrapModeV, _linearFiltering });
        }
        ...
        Texture * getTexture(TexSamplerHdl _hdl) const;
        SamplerMode getSamplerMode(TexSamplerHdl _hdl) const;
    ...
    private:
        ...
        struct TextureAndSamplerMode
        {
            Texture* texture = nullptr; // can be null if no texture is set. Used for debugging purpose
        ...
        ParamContainer<TextureAndSamplerMode> m_texAndSamplers;

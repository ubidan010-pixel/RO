...
// Device info.
#define NX_DEFERRED_DEVICE_NAME		AKTEXT("NX Deferred")	// Default deferred device name.
    ...
    )
{
	...
	AK_OSCHAR_TO_UTF16(out_deviceDesc.szDeviceName, NX_DEFERRED_DEVICE_NAME, AK_MONITOR_DEVICENAME_MAXLENGTH);

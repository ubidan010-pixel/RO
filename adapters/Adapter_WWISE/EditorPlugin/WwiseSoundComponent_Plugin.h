#ifndef __WWISESOUNDCOMPONENT_PLUGIN_H__
#define __WWISESOUNDCOMPONENT_PLUGIN_H__

#ifdef todoisap //todoisap
...
namespace	ITF
{
	class WwiseSoundComponent_Plugin :
		public Interface_ActorEditorListener
	{


	public:
			static WwiseSoundComponent_Plugin		*s_getSingleton()	{ return m_singleton; }
			static Interface_ActorEditorListener	*create();
			virtual void							destroy();

			WwiseSoundComponent_Plugin();
			virtual									~WwiseSoundComponent_Plugin()													{ }
	...
	private:
			static WwiseSoundComponent_Plugin	    *m_singleton;
			ActorRefList				            m_drawSoundComponentActorList;
			u32							            m_showMask;			

			void								    drawSoundComponentActors();
	};
}	// namespace ITF
#endif

#endif
#endif // __WWISESOUNDCOMPONENT_PLUGIN_H__

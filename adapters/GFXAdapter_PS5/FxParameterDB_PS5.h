...
namespace ITF
{
    ...
    public:
        ...
        using TexSamplerHdl = Handle<Gnmp::Sampler>;
        ...
        void setTexture(TexSamplerHdl _hdl, PS5Texture* _texture);
        void setSampler(TexSamplerHdl _hdl, Gnmp::Sampler _sampler);
        void setTextureAndSampler(TexSamplerHdl _hdl, PS5Texture* _tex, Gnmp::Sampler _sampler) { setTextureAndSampler(_hdl, { _tex, _sampler }); }
        void setTextureAndSampler(TexSamplerHdl _hdl, TextureAndSampler _texAndSampler);
        ...
        Gnmp::Sampler getSampler(TexSamplerHdl _hdl) const;
        PS5Texture * getTexture(TexSamplerHdl _hdl) const;
        TextureAndSampler getTextureAndSampler(TexSamplerHdl _hdl) const;
    ...
    private:
        ...
        ParamContainer<TextureAndSampler> m_texAndSamplers;

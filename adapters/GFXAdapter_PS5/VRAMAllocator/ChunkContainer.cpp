...
namespace ITF::Gnmp::VRAMAllocator
{
    ...
    void ChunkContainer::Init(VRAMAddress startOfBlock, ChunkSize blockSize, VRAMMemoryBus memBus, bool forceOOMBreak, bool verboseOutOfMem, bool staticBuffer)
    {
        m_memBus = memBus;

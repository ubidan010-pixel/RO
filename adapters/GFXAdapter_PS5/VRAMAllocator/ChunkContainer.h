...
{
    // minimal block size
    const ChunkSize MinimalChunkSize = 256;
    const ChunkSize MinimalAlignment = 256; // has to be a multiple of MinimalChunkSize

    u8 * const InvalidAddress = nullptr;
    ...
    public:
        ...
        void Init(VRAMAddress startOfBlock, ChunkSize blockSize, VRAMMemoryBus memBus, bool forceOOMBreak, bool verboseOutOfMem = false, bool staticBuffer = false);
        ...
        VRAMMemoryBus GetMemoryBus() const { return m_memBus; }

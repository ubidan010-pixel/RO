...
namespace ITF
{
    ...
    {
        Gnmp::Sampler sampler;
        sampler.init();
        return TexSamplerHdl{ m_texAndSamplers.add(_name, {nullptr, sampler}) };
    }
    ...
    void FxParameterDB::setTexture(TexSamplerHdl _hdl, PS5Texture * _texture)
    {
        m_texAndSamplers.get(_hdl.getIdx()).texture = _texture;
    }

    void FxParameterDB::setSampler(TexSamplerHdl _hdl, Gnmp::Sampler _sampler)
    {
        m_texAndSamplers.get(_hdl.getIdx()).sampler = _sampler;
    }

    void FxParameterDB::setTextureAndSampler(TexSamplerHdl _hdl, TextureAndSampler _texAndSampler)
    {
        m_texAndSamplers.get(_hdl.getIdx()) = _texAndSampler;
    }
    ...
    Gnmp::Sampler FxParameterDB::getSampler(TexSamplerHdl _hdl) const
    {
        return m_texAndSamplers.get(_hdl.getIdx()).sampler;
    }
    PS5Texture* FxParameterDB::getTexture(TexSamplerHdl _hdl) const
    {
        return m_texAndSamplers.get(_hdl.getIdx()).texture;
    }

    FxParameterDB::TextureAndSampler FxParameterDB::getTextureAndSampler(TexSamplerHdl _hdl) const
    {
        return m_texAndSamplers.get(_hdl.getIdx());
    }

...
*****************************************************************************/
	static PVRTMat4 PerspectiveFov(
		...
		bool bRotate = false)
	{
		VERTTYPE height = VERTTYPEMUL(VERTTYPEMUL(f2vt(2.0f),nearPlane),tanf(VERTTYPEMUL(fovy,f2vt(0.5f))));
...
*****************************************************************************/
	static PVRTMat4 PerspectiveFovFloatDepth(
		...
		bool bRotate = false)
	{
		VERTTYPE height = VERTTYPEMUL(VERTTYPEMUL(2,nearPlane), tanf(VERTTYPEMUL(fovy,0.5)));

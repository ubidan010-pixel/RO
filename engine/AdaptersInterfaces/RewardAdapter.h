...
namespace ITF
{
    ...
    #define s_REWARD_RAY_CLEAR_SIGHTED ITF_GET_STRINGID_CRC(REWARD_RAY_CLEAR_SIGHTED,591191195)
    #define s_REWARD_RAY_EAGLE_EYED ITF_GET_STRINGID_CRC(REWARD_RAY_EAGLE_EYED,463513204)

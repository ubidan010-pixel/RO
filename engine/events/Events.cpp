...
IMPLEMENT_OBJECT_RTTI(EventActorActiveChanged)
IMPLEMENT_OBJECT_RTTI(EventOnlineSessionCreated)
IMPLEMENT_OBJECT_RTTI(EventOnlineSessionError)
IMPLEMENT_OBJECT_RTTI(EventControllerStateChanged)

...
public:
     ...
     */
    hlPlayer(const VideoPlayerInit & playerInit, cell::Sail::memallocator* memoryReplacement = NULL, cell::Sail::CustomSource * fileReplacement = NULL);
     ...
     */
	bool Play(const char* videouri, bool looping=false); 
    ...
    void updateVideoSync(uint32_t _tag, uint64_t _flipTime);
